<?php $nome_completo = $_POST['nome_completo'];
...
$midia->AddMidia($nome_completo, $nome_capa, $ano_lancamento, $num_episodios, $num_temporadas, $num_temporada, $img_capa, $genero, $duracao, $link_midia, $link_intru, $link_amv, $descri, $tipo_conteudo, $faixa_etaria, $link_trailer, $tipo_midia);
