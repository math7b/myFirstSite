        ...
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-7 col-lg-12 col-xl-12">
                            <div class="det_detalhes">
                                <h6>
                                    <b>Nome:</b> <?php echo $linha->nome_capa; ?><br><br>
                                    <b>Maior de:</b> <?php echo $linha->faixa_etaria; ?><br><br>
                                    <b>Ep:</b> <?php echo $linha->num_episodios; ?><br>
                                    <b>Temoradas:</b> <?php echo $linha->num_temporadas; ?><br>
                                    <b>Temporada:</b> <?php echo $linha->num_temporada; ?>
            ...
            <div class="col-sm-12 col-md-12- col-lg-8 col-xl-9">
                ...
                <div class="det_link">
                    ...
                    <a href="./?pagina=alt_pendente&id=<?php echo $linha->midiaId; ?>&tipo_midia=serie">
                        <button type="button">
                            <h6>
                    ...
                    <a href="./?pagina=alt_favorito&id=<?php echo $linha->midiaId; ?>&tipo_midia=serie">
                        <button type="button">
                            <h6>
                    ...
                    if( $_SESSION['usuario'] == $admin or $ajudante ) { ?>
                        <a href="./?pagina=excluirMidia&midiaId=<?php echo $linha->midiaId; ?>&tipo_midia=serie">
                            <button type="button">
                                <h6>Deletar</h6>
                            </button>
                        </a>
                        <a href="./?pagina=editar_serie&midiaId=<?php echo $linha->midiaId; ?>&tipo_midia=serie">
                            <button type="button">
                                <h6>Editar</h6>
                            </button>
                        </a>
